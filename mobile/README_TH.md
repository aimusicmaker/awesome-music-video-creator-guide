...
- **[Seedance 2.5](https://seed.bytedance.com/en/seedance2_5)** — วางแผนเสียงกับภาพร่วมกัน ชนิดข้อมูลอ้างอิงขึ้นอยู่กับเครื่องมือ
- **[MiniMax H3](https://www.minimax.io/blog/minimax-h3)** — ตัวอย่างทางการแบ่งหน้าที่ของภาพ วิดีโอ และเสียงชัดเจน
- **[MiniMax Music 3.0](https://www.minimax.io/blog/minimax-music-3-0-next-generation-open-weights-production-ready-versatile-music-model)** — เริ่มจากแนวคิดและเนื้อร้องที่มีหรือไม่มีก็ได้ กำหนดโครงเพลงก่อน
- **[Eleven Music](https://elevenlabs.io/docs/overview/capabilities/music/best-practices)** — ระบุแนวเพลง อารมณ์ เครื่องดนตรี และความเร็วให้ชัด
